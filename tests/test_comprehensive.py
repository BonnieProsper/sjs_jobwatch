...
def test_models():
    ...
    from sjs_jobwatch.core.models import Job, Severity, Snapshot
...
def test_diff_logic():
    ...
    from sjs_jobwatch.core.diff import compare_jobs, diff_snapshots
...
def test_data_structures():
    ...
    from sjs_jobwatch.core.models import FieldChange, Job, JobChange
